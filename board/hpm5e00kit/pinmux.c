...
void init_enet_pins(ENET_Type *ptr)
{
    if (ptr == HPM_ENET0) {
#if defined(MII) && MII
        HPM_IOC->PAD[IOC_PAD_PA09].FUNC_CTL = IOC_PA09_FUNC_CTL_ESC0_REFCK | IOC_PAD_FUNC_CTL_LOOP_BACK_MASK;
...
void init_esc_pins(void)
{
    ...
    HPM_IOC->PAD[IOC_PAD_PA09].FUNC_CTL = IOC_PA09_FUNC_CTL_ESC0_REFCK;
    HPM_IOC->PAD[IOC_PAD_PD02].FUNC_CTL = IOC_PD02_FUNC_CTL_ESC0_SCL;
    HPM_IOC->PAD[IOC_PAD_PD03].FUNC_CTL = IOC_PD03_FUNC_CTL_ESC0_SDA;
    HPM_IOC->PAD[IOC_PAD_PB26].FUNC_CTL = IOC_PB26_FUNC_CTL_ESC0_CTR_6;
    HPM_IOC->PAD[IOC_PAD_PB26].PAD_CTL = IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1); /* Internally pull up to avoid suspension */
